...
# cityscapes2gta/ gta2cityscapes
# _C.MODEL.NUM_CLASSES = 19
# pascal2realart
_C.MODEL.NUM_CLASSES = 12
...
# pascal2realart
_C.INPUT.SOURCE_INPUT_SIZE_TRAIN = (513, 513)
_C.INPUT.TARGET_INPUT_SIZE_TRAIN = (513, 513)
_C.INPUT.INPUT_SIZE_TEST = (513, 513)

# cityscapes2gta
# _C.INPUT.SOURCE_INPUT_SIZE_TRAIN = (1024, 512)
# _C.INPUT.TARGET_INPUT_SIZE_TRAIN = (1280, 720)
# _C.INPUT.INPUT_SIZE_TEST = (1280, 720)
...
_C.MODEL.MULTI_TEST_WEIGHTS = []
_C.DATASETS.MULTI_TEST_WEIGHTS_DATASETS = []
_C.DATASETS.WEIGHT_VEC_DICT_PATH = ""

_C.DATASETS.TRAIN_GRAM_EMBEDDINGS = ""
